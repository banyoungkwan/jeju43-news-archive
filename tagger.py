"""제주4.3 뉴스 아카이브 - OpenRouter DeepSeek R1 태거
수집된 기사에 자동으로 태그/주제/인물을 추출·부착

OpenRouter API (DeepSeek R1 추론 모델) 사용
"""
import os
import json
import logging
...
# 사용 모델: DeepSeek R1 추론 모델
# deepseek/deepseek-r1 : 163K context, MIT 라이선스, o1급 추론 성능
# 환경변수로 모델 변경 가능
MODEL = os.environ.get('OPENROUTER_MODEL', 'deepseek/deepseek-r1')
...
# ── 프롬프트 ────────────────────────────────────────────────
SYSTEM_PROMPT = """당신은 제죸4.3사건 관련 뉴스 기사를 분석하는 전문가입니다.
